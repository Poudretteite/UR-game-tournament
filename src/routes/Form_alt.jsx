        ...
        <>
            <main className='max-w-4xl mx-auto'>
                <img src={assets.logo_text} alt="logo" className="-mt-28 -mb-28 h-[6rem] md:h-[13rem] mx-auto hidden md:block z-20 drop-shadow-[0_0_20px_#1952ff]" />
                    ...
                    <h2 className="text-6xl font-semibold py-3 text-white italic">Rejestracja dobiegła końca.</h2>
                    <h2 className="text-3xl font-semibold text-white"> Do zobaczenia na turnieju! Śledźcie nasze social media, żeby być na bieżąco z najnowszymi informacjami.</h2>
                </div>
            </main>
        </>
    )
